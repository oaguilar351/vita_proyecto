...
if (($x_Rec_RFC == "") || (is_null($x_Rec_RFC))) {
	ob_end_clean();
	header("Location: receptores_listado.php");
	exit();
}
                                                ...
                                                <div class="row">
													...
													<div class="col-lg-2" style="background-color:#fdedec;">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" name="x_Rec_FechaInicioRelLaboral" id="x_Rec_FechaInicioRelLaboral" 
                                                                        class="form-control" data-provider="flatpickr" data-date-format="Y M D"
                                                                        placeholder="Favor de elegi una fecha" value="<?php echo FormatDateTime(@$_GET["x_Rec_FechaInicioRelLaboral"],5); ?>" />
															</div>
                                                    </div>
                                                    <!--end col-->
													<div class="col-lg-2" style="background-color:#fdedec;">
													...
													<br />
                                                        <div class="hstack gap-2 justify-content-end">
															...
															<a class="btn btn-soft-primary waves-effect waves-light" href="receptores_listado.php">Cancelar</a>
