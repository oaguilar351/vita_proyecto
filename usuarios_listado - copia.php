	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
				...
				<?php } else { ?>
				<a href="<?php if ($x_Vit_Usuario <> "" AND $x_Mun_ID <> "") {echo "usuarios_listado.php?a=edit&Vit_Usuario=" . urlencode($x_Vit_Usuario) . "&Mun_ID=" . urlencode($x_Mun_ID); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Editar</a>
				<?php } ?>
				</li>				
			</ul>
			<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
				<li>
				<a href="<?php if ($x_Vit_Usuario <> "" AND $x_Mun_ID <> "") {echo "vit_usuariosdelete.php?Vit_Usuario=" . urlencode($x_Vit_Usuario) . "&Mun_ID=" . urlencode($x_Mun_ID); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Eliminar</a>
				</li>
			</ul>
		</div>
	</td>
