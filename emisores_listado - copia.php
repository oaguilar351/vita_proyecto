...
<?php if ($nTotalRecs > 0)  { ?>
											<form name="vit_emisorlist" id="vit_emisorlist" action="emisores_listado.php" method="post" enctype="multipart/form-data">
...
RFC
<?php }else{ ?>
	<a href="emisores_listado.php?order=<?php echo urlencode("Emi_RFC"); ?>">RFC&nbsp;(*)<?php if (@$_SESSION["vit_emisor_x_Emi_RFC_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_emisor_x_Emi_RFC_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
Nombre
<?php }else{ ?>
	<a href="emisores_listado.php?order=<?php echo urlencode("Emi_Nombre"); ?>">Nombre&nbsp;(*)<?php if (@$_SESSION["vit_emisor_x_Emi_Nombre_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_emisor_x_Emi_Nombre_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
Rfc Patron Origen
<?php }else{ ?>
	<a href="emisores_listado.php?order=<?php echo urlencode("Emi_RfcPatronOrigen"); ?>">Rfc Patron Origen&nbsp;(*)<?php if (@$_SESSION["vit_emisor_x_Emi_RfcPatronOrigen_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_emisor_x_Emi_RfcPatronOrigen_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
Municipio
<?php }else{ ?>
	<a href="emisores_listado.php?order=<?php echo urlencode("Mun_ID"); ?>">Municipio<?php if (@$_SESSION["vit_emisor_x_Mun_ID_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_emisor_x_Mun_ID_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
...
<?php }else{ ?>
<?php echo str_replace(chr(10), "<br>", $x_Emi_Nombre); ?>
<?php } ?>
</span></td>
		<!-- Emi_RfcPatronOrigen -->
		<td><span class="phpmaker">
<?php if ($bEditRow) { // Edit Record ?>
<input type="text" name="x_Emi_RfcPatronOrigen" id="x_Emi_RfcPatronOrigen" size="30" maxlength="39" value="<?php echo htmlspecialchars(@$x_Emi_RfcPatronOrigen) ?>">
<?php }else{ ?>
<?php echo $x_Emi_RfcPatronOrigen; ?>
<?php } ?>
</span></td>
		<!-- Mun_ID -->
		<td><span class="phpmaker">
...
<?php }else{ ?>
<?php if ((!is_null($x_Emi_ArchivoKey)) &&  $x_Emi_ArchivoKey <> "") { ?>
<a href="<?php echo ewUploadPath(0) . $x_Emi_ArchivoKey ?>" target="_blank"><i class="ri-key-line" style="font-size:24px;"></i> <?php #echo $x_Emi_ArchivoKey; ?></a>
<?php } ?>
<?php } ?>
</span></td>
		<!-- Emi_ArchivoCer -->
...
<?php }else{ ?>
<?php if ((!is_null($x_Emi_ArchivoCer)) &&  $x_Emi_ArchivoCer <> "") { ?>
<a href="<?php echo ewUploadPath(0) . $x_Emi_ArchivoCer ?>" target="_blank"><i class="ri-shield-keyhole-fill" style="font-size:24px;"></i> <?php #echo $x_Emi_ArchivoCer; ?></a>
<?php } ?>
<?php } ?>
</span></td>
<?php if ($sExport == "") { ?>
...
<a href="" onClick="if (EW_checkMyForm(document.vit_emisorlist)) document.vit_emisorlist.submit();return false;">Update</a>&nbsp;<a href="emisores_listado.php?a=cancel">Cancel</a>
<input type="hidden" name="a_list" value="update">
<input type="hidden" name="EW_Max_File_Size" value="20000000">
<?php } else { ?>
<a href="<?php if ($x_Emi_RFC <> "" AND $x_Mun_ID <> "") {echo "emisores_listado.php?a=edit&Emi_RFC=" . urlencode($x_Emi_RFC) . "&Mun_ID=" . urlencode($x_Mun_ID); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Inline Edit</a>
<?php } ?>
</span></td>-->
<td><span class="phpmaker">
<div class="dropdown">
                                        ...
                                        <!--<form action="" class="d-flex flex-column justify-content-end h-100">-->
                                            <div class="offcanvas-body">
												<div class="mb-4">
													...
													<input class="form-control" type="text" name="n_Emi_RFC" id="n_Emi_RFC" size="30" maxlength="39" value="">
                                                </div>
												<div class="mb-4">
                                                    <label for="Nombre" class="form-label text-muted text-uppercase fw-semibold mb-3">Nombre</label>
                                                    <input class="form-control" type="text" name="n_Emi_Nombre" id="n_Emi_Nombre" size="30" value="">
                                                </div>
												<div class="mb-4">
                                                ...
                                                <div class="mb-4">
                                                    <label for="country-select"
                                                        class="form-label text-muted text-uppercase fw-semibold mb-3">Rfc Patron Origen</label>
														<input class="form-control"  type="text" name="n_Emi_RfcPatronOrigen" id="n_Emi_RfcPatronOrigen" size="30" maxlength="39" value="">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="country-select"
