...
$sSqlWrk = "
SELECT
Count(vit_comprobantes.Cfdi_Error) AS timbrados
FROM
vit_comprobantes
...
$sSqlWrk = "
SELECT
Count(vit_comprobantes.Cfdi_Error) AS Activos
FROM
vit_comprobantes
WHERE vit_comprobantes.Cfdi_Error = 'Success'
...
$sSqlWrk = "
SELECT
Count(vit_comprobantes.Cfdi_Error) AS Cancelados
FROM
vit_comprobantes
WHERE vit_comprobantes.Cfdi_Error = 'Success'
...
$sSqlWrk = "
SELECT
Count(vit_comprobantes.Cfdi_Error) AS NTimbrados
FROM
vit_comprobantes
WHERE vit_comprobantes.Cfdi_Error <> 'Success'
#AND vit_comprobantes.Cfdi_Status = 'C' ";
