...
Categoria
<?php }else{ ?>
	<a href="vit_receptorlist.php?order=<?php echo urlencode("Rec_NumEmpleado"); ?>">Categoria<?php if (@$_SESSION["vit_receptor_x_Rec_NumEmpleado_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_receptor_x_Rec_NumEmpleado_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</th>
		<th>
<?php if ($sExport <> "") { ?>
...
Fecha Inicio
<?php }else{ ?>
	<a href="vit_receptorlist.php?order=<?php echo urlencode("Rec_FechaInicioRelLaboral"); ?>">Fecha Inicio<?php if (@$_SESSION["vit_receptor_x_Rec_FechaInicioRelLaboral_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_receptor_x_Rec_FechaInicioRelLaboral_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</th>		
		<th>
<?php if ($sExport <> "") { ?>
Constancia
<?php }else{ ?>
	<a href="javascript:void(0);">Constancia</a>
<?php } ?>
		</th>
		<th>
<?php if ($sExport <> "") { ?>
Emisor
<?php }else{ ?>
	<a href="javascript:void(0);">Emisor<?php if (@$_SESSION["vit_receptor_x_Mun_ID_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vit_receptor_x_Mun_ID_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</th>
<?php if ($sExport == "") { ?>
<!--<th>&nbsp;</th>
...
if ((!is_null($x_Rec_RFC)) && ($x_Rec_RFC <> "")) {
	...
	$sSqlWrk .= " WHERE const_RFC = '" . $x_Rec_RFC . "'";
	#echo $sSqlWrk;
...
?>	
	<a href="receptor_constancia.php?showmaster=1&const_RFC=<?php echo urlencode($x_Rec_RFC); ?>"><i class="ri-checkbox-multiple-fill" style="font-size:16px; color:#689f38;"></i></a>
<?php	
	} else {
?>	
...
if ((!is_null($x_Rec_RFC)) && ($x_Rec_RFC <> "")) {
	...
	WHERE vit_comprobantes.Rec_RFC = '" . $x_Rec_RFC . "'
	AND vit_comprobantes.Cfdi_Retcode = '1'
	ORDER BY Vit_Nominas.Nom_FechaInicialPago DESC
	LIMIT 1
	";
	$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error($conn) . ' SQL:' . $sSqlWrk);
	if ($rswrk && $rowwrk = phpmkr_fetch_array($rswrk)) {
		echo strtoupper($rowwrk["Emi_Nombre"]);
	}
                                        ...
                                        <!--<form action="" class="d-flex flex-column justify-content-end h-100">-->
                                            <div class="offcanvas-body">
												<div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_RFC" id="s_Rec_RFC" size="30" maxlength="120" placeholder="RFC" value="<?php echo htmlspecialchars(@$_GET["s_Rec_RFC"]) ?>">
                                                </div>
												<div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_Nombre" id="s_Rec_Nombre" size="30" placeholder="Nombre" value="<?php echo htmlspecialchars(@$_GET["s_Rec_Nombre"]); ?>">
                                                </div>
												<div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_Apellido_Paterno" id="s_Rec_Apellido_Paterno" size="30" placeholder="Apellido Paterno" value="<?php echo htmlspecialchars(@$_GET["s_Rec_Apellido_Paterno"]); ?>">
                                                </div>
												<div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_Apellido_Materno" id="s_Rec_Apellido_Materno" size="30" placeholder="Apellido Materno" value="<?php echo htmlspecialchars(@$_GET["s_Rec_Apellido_Materno"]); ?>">
                                                </div>
                                               <div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_Curp" id="s_Rec_Curp" size="30" placeholder="Curp" value="<?php echo htmlspecialchars(@$_GET["s_Rec_Curp"]); ?>">
                                                </div>
												 <div class="mb-4">
                                                    ...
                                                    <input class="form-control" type="text" name="s_Rec_NumEmpleado" id="s_Rec_NumEmpleado" size="30" placeholder="Num Empleado" value="<?php echo htmlspecialchars(@$_GET["s_Rec_NumEmpleado"]); ?>">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="country-select"
														...
														$x_Emi_RFCList .= "<option value=''>Departamentos | Favor de elegir</option>";
														...
														if ($rswrk) {
															...
															while ($datawrk = phpmkr_fetch_array($rswrk)) {
																$x_Emi_RFCList .= "<option value=\"" . htmlspecialchars($datawrk["Rec_Departamento"]) . "\"";
																if ($datawrk["Rec_Departamento"] == @$_GET["s_Rec_Departamento"]) {
																	$x_Emi_RFCList .= "' selected";
																}
																$x_Emi_RFCList .= ">" . $datawrk["Rec_Departamento"] . "</option>";
																$rowcntwrk++;
															}
														}
														@phpmkr_free_result($rswrk);
                                            ...
                                            <div class="offcanvas-footer border-top p-3 text-center hstack gap-2">
												...
												<?php if(@$_SESSION["vit_receptor_OrderBy"]!=""){ ?>												
												<a class="btn btn-primary waves-effect waves-light w-100" href="receptores_listado.php?cmd=resetsort">Quitar Orden</a>
												<?php } ?>											
												<a class="btn btn-primary waves-effect waves-light w-100" href="receptores_listado.php?cmd=reset">Cancelar</a>
                                                <button type="submit" name="Action" class="btn btn-success waves-effect waves-light w-100">Filtrar</button>
