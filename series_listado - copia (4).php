...
?>
                                             <div class="flex-grow-1 ms-3">
                                                <p class="text-uppercase fw-medium text-muted mb-3">Total Percepciones</p>
											
                                                <h4 class="fs-4 mb-3 text-muted"><span class="counter-value" data-target="<?php echo $Nom_TotalPercepciones; ?>">0</span></h4>
                                             </div>
                                         </div>
                                    </div><!-- end card body -->
                                </div>
                                ...
                                <div class="card card-height-100">
                                    <div class="card-body">
                                         <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-grow-1 ms-3">
                                                <p class="text-uppercase fw-medium text-muted mb-3">Total Deducciones</p>
									
                                                <h4 class="fs-4 mb-3"><span class="counter-value" data-target="<?php echo $Nom_TotalDeducciones; ?>">0</span></h4>
                                             </div>
                                         </div>
                                    </div><!-- end card body -->
                                </div>
                                ...
                                <div class="card card-height-100">
                                    <div class="card-body">
                                         <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-grow-1 ms-3">
                                                <p class="text-uppercase fw-medium text-muted mb-3">Total Otros Pagos</p>
												
                                                <h4 class="fs-4 mb-3"><span class="counter-value" data-target="<?php echo $Nom_TotalOtrosPagos; ?>">0</span></h4>
                                             </div>
                                         </div>
                                    </div><!-- end card body -->
                                </div>
                                ...
                                <div class="card card-height-100">
                                    <div class="card-body">
                                         <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-grow-1 ms-3">
                                                <p class="text-uppercase fw-medium text-muted mb-3">Total Monto Recurso Propio</p>
												
                                                <h4 class="fs-4 mb-3"><span class="counter-value" data-target="<?php echo $Nom_MontoRecursoPropio; ?>">0</span></h4>
                                             </div>
                                         </div>
                                    </div><!-- end card body -->
                                </div>
