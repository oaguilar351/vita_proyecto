...
<table class="table align-middle" id="customerTable">
	...
	<a href="constancias_listado.php?order=<?php echo urlencode("const_Nombres"); ?>">Nombres<?php if (@$_SESSION["constancias_x_const_Nombres_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_Nombres_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		...
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_Apellido1"); ?>">Paterno<?php if (@$_SESSION["constancias_x_const_Apellido1_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_Apellido1_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_Apellido2"); ?>">Materno<?php if (@$_SESSION["constancias_x_const_Apellido2_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_Apellido2_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_InicioOperaciones"); ?>">Inicio <?php if (@$_SESSION["constancias_x_const_InicioOperaciones_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_InicioOperaciones_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_EstatusPadron"); ?>">Estatus <?php if (@$_SESSION["constancias_x_const_EstatusPadron_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_EstatusPadron_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_NombreComercial"); ?>">Comercial<?php if (@$_SESSION["constancias_x_const_NombreComercial_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_NombreComercial_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
	<a href="constancias_listado.php?order=<?php echo urlencode("const_CodigoPostal"); ?>">Cod. Postal<?php if (@$_SESSION["constancias_x_const_CodigoPostal_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["constancias_x_const_CodigoPostal_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
		</span></th>
		<th valign="top"><span>
                                        ...
                                        <!--<form action="" class="d-flex flex-column justify-content-end h-100">-->
                                            <div class="offcanvas-body">
												<div class="mb-4">
													...
													<input class="form-control" type="text" name="x_const_Ruta" id="x_const_Ruta" size="30" maxlength="200" placeholder="Codigo QR" value="">
                                                </div>
                                            </div>
                                            <!--end offcanvas-body-->
                                            <div class="offcanvas-footer border-top p-3 text-right hstack gap-2">
												<a class="btn btn-primary waves-effect waves-light w-100" href="constancias_listado.php?cmd=reset">Cancelar</a>
                                                <button type="submit" name="Action" class="btn btn-success waves-effect waves-light w-100" value="ADD">Enviar</button>
