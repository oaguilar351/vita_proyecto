...
<?php if ($sExport == "") { ?>
	...
	<div class="dropdown">
		...
		<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
			...
			<li>
			<a class="dropdown-item" onclick = "if(!confirm('Confirmar que desea eliminar el registro?')) return false;" href="<?php if ($x_Vit_Usuario <> "" AND $x_Mun_ID <> "") {echo "usuarios_listado.php?Vit_Usuario=" . urlencode($x_Vit_Usuario) . "&Mun_ID=" . urlencode($x_Mun_ID) ."&a_delete=D"; } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Eliminar</a>			
			</li>
		</ul>
	</div>
	<?php } ?>
